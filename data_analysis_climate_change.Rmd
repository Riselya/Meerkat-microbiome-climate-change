---
title: "Rmarkdown: Climate change and tuberculosis drive non-adaptive shifts in gut microbiota of wild meerkats"
author: "Alice Risely"
date: "16/09/2022"
output:
  html_document:
...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE, fig.height = 4, fig.width =6, time_it = TRUE, error = TRUE)
```
...
# Fig. 1a-d: Yearly trends in climate and TB
...
# Fig. 2e-i: Gut microbiome and metadata summary
...
# Fig. S2: Storage, time of day, and social group per sample
...
# Fig S3. Visualising raw data per individual
...
# Figs S4, S5 and S9. Split by storage, season and group
...
# Model genus level changes

### Model year as a smoothed continuous variable
